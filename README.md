...
Если сервер был переустановлен и при подключении ты видишь сообщение:

```text
WARNING: REMOTE HOST IDENTIFICATION HAS CHANGED!
```

это обычно значит, что у сервера поменялся SSH host key после переустановки.

Тогда на своём компьютере удали старую запись о сервере:
