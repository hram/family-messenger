...
INSERT INTO system_setup (id, family_id, master_password_hash, initialized_at, server_instance_id)
VALUES (1, 1, 'seed-bootstrap-placeholder', NOW(), 'seed-demo-server-instance')
ON CONFLICT (id) DO NOTHING;
