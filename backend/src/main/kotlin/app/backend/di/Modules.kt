...
import app.backend.repository.ExposedAdminRepository
import app.backend.repository.ExposedAuthRepository
import app.backend.repository.ExposedClientLogRepository
import app.backend.repository.ExposedDeviceRepository
import app.backend.repository.ExposedMessageRepository
import app.backend.repository.ExposedPresenceRepository
import app.backend.repository.ExposedProfileRepository
import app.backend.repository.ExposedSetupRepository
